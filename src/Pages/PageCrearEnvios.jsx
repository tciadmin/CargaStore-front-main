  ...
  return (
    <section style={{ background: "#F6F6F6", height: "100%" }} id="arriba">
      <Container maxWidth={"md"} sx={{ padding: "20px 0" }}>
        ...
        <Typography variant="h6" sx={{ fontSize: "16px", color: "#8C94A6", textAlign: "center", fontWeight: 400 }} >{descripciones[stepIndex]}</Typography>
        {
          stepIndex === 0 &&
          <>
        ...
        }
        {
          ...
          <>
            ...
            <InputForm label="Tipo de carga" type="select" select={select}></InputForm>
            <InputForm label="Peso total"></InputForm>
            <InputForm label="Volumen del paquete"></InputForm>
            <InputForm label="Valor ofertado" money={true}></InputForm>
            ...
            <Grid my={2} container justifyContent={"flex-start"} spacing={1}>
              <Grid item xs={4} md={3}>
                <img src="/crearenvios/i1.png" width={"150px"} alt="imagen de prueba" />
              </Grid>
              <Grid item xs={4} md={3}>
                <img src="/crearenvios/i2.png" width={"150px"} alt="imagen de prueba" />
              </Grid>
              <Grid item xs={4} md={3}>
                <img src="/crearenvios/i3.png" width={"150px"} alt="imagen de prueba" />
              </Grid>
              <Grid item xs={4} md={3}>
                <img src="/crearenvios/i4.png" width={"150px"} alt="imagen de prueba" />
              </Grid>
            </Grid>
          </>
        }
        ...
        <Button sx={{ width: "100%", padding: "18px 0", fontWeight: "bold", fontSize: "16px" }}
