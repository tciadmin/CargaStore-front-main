                    ...
                    (
                     ...
                     arrayChat?.map((e, index)=>{
                        ...
                        key={index}
                         ...
                         >
                            <Avatar width="40px" src={`${serverURL}/${chats[indexReceptor]?.personWithChat.profile_image}`} height="40px" ></Avatar>
                                    ...
                                    <Grid item xs={8}>
                                        <Typography
                                            ...
                                            color="#000" sx={{
                                                ...
                                                whiteSpace: 'nowrap',
                                                maxWidth: '100%',
                                            }}>{e[1].message}{' '}</Typography>

                                    </Grid>
                                    <Grid item xs={4}>
                                        <Typography width="100px" maxWidth="100%" fontSize={"12px"} color={"#8C94A6"}>
