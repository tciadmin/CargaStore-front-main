import { Avatar, Box, Button, Grid, Modal, Rating, Stack, Typography, useMediaQuery } from '@mui/material'
        ...
        <>
            <Grid container>
                ...
                <Grid item container direction={"row"} width={"100%"} justifyContent={"center"} mt={3} xs={12}>
                    <Button style={{ alignSelf: "center", fontWeight: 600 }} onClick={() => handleOpen()}>Ver factura</Button>
                </Grid>
            </Grid>
            <Modal
                open={open}
