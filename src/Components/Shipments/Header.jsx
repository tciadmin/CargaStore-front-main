            ...
            <AppBar position="static" background="primary">
                <Container maxWidth="xl">
                    ...
                    <Toolbar disableGutters>
                        ...
                        {isLogin &&
                            <>
                                <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
                                    ...
                                    >
                                        {pages.map((page) => (
                                            <MenuItem key={page} color='secondary' onClick={handleCloseNavMenu}>
                                                <Typography color={"secondary"} fontWeight={200} textAlign="center" >{page}</Typography>
                                            </MenuItem>
                                        ))}
                                    </Menu>
                                </Box>
                        ...
                        {isLogin &&
                            <>
                                <Box display="flex" justifyContent="center" alignItems="center" sx={{ flexGrow: 0 }}>
                                    <Tooltip title="Messages" sx={{ pr: 2 }}>
                                        <EmailOutlinedIcon fontWeight="light" color={"secondary"}></EmailOutlinedIcon>

                                    </Tooltip>
                                    <Tooltip title="Notifications" sx={{ pr: 1 }}>

                                        <NotificationsNoneOutlinedIcon color={"secondary"}></NotificationsNoneOutlinedIcon>
                                    </Tooltip>
