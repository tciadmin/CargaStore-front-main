          ...
          {!mobile &&
            <Stack direction="row" justifyContent={"flex-start"} alignItems={"center"} >
              ...
              {!mobile && location.pathname != "/landing" &&
                <>
                  <Typography fontSize={"16px"} sx={{ cursor: "pointer" }} onClick={() => { if(location.pathname.startsWith("/administrador")){
                      navigate("/administrador/panel")
                    }else{
                      navigate("/marketplace")
                    }}} marginRight={2} cursor="pointer" color={location.pathname == "/marketplace" ? "primary" : "secondary"} >
                   {location.pathname.startsWith("/administrador") ?"Panel de control" : "Marketplace"}

                  </Typography>
                  <Typography fontSize={"16px"} sx={{ cursor: "pointer" }} onClick={() => {
                    if(location.pathname.startsWith("/administrador")){
                      navigate("/payment")
                    }else{
                      navigate("/shipments")
                    }
                    }} color={location.pathname.startsWith("/shipments") ? "primary" : "secondary"}>
                  {location.pathname.startsWith("/administrador") ?"Pagos" : "Mis envíos"}                  </Typography>
                </>
              }
            ...
            <Box display="flex" justifyContent="center" alignItems="center" alignSelf="flex-end" sx={{ flexGrow: 0 }}>
              ...
              >
                ...
                <MenuItem key={453} onClick={handleCloseUserMenu}>
                  <Typography textAlign="center" onClick={() => navigate("/perfil")}>Ajustes del perfil</Typography>

                </MenuItem>
                <MenuItem key={464} onClick={handleCloseUserMenu} >
                  <Typography textAlign="center" onClick={() => navigate("/landing")}>Cerrar sesión</Typography>
