                    ...
                    {!chatear ? (
                        ...
                        <>
                                ...
                                {messages ?
                                    (messages.slice().reverse().map((e, index) => {                                       
                                        ...
                                        if (parseInt(e.emisorID) == parseInt(Cookies.get('id'))) {
                                            ...
                                            return <ReceptorMessage key={index} date={e.createdAt} message={e.message}></ReceptorMessage>
                            ...
                            >
                                ...
                                <ReceptorWriting nameOfUser={chats[indexReceptor].personWithChat.name + "  " + chats[indexReceptor].personWithChat.lastname}></ReceptorWriting>
